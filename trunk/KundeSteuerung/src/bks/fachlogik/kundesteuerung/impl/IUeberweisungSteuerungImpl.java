...
public class IUeberweisungSteuerungImpl implements IUeberweisungSteuerung {
    ...
    private final IUeberweisungsVorlageImpl ueberweisungsVorlage = new IUeberweisungsVorlageImpl();
    ...
    public List<UeberweisungGrenz> getStornierbareUeberweisungen() {
        ...
        stornierbareUbvList = kontoService.getStornierbareUeberweisungen(this.kunde.getKid());
    ...
    /**
     * Markiert eine Überweisung als stornierbar.
     *
     * @param  ubid ÜberweisungsID der zu löschenden Überweisung
     * @return true, falls eine Überwesiung erfolgreich als stornierbar markiert wurde,
     *         false, falls ein Fehler aufgetaucht ist.
     * @author Alejandro Palacios
     */
    @Override
    public boolean ueberweisungStornieren(int ubid) {
        this.kontoService.ueberweisungStornieren(ubid);
        return true;
    }
